...
class GetRelatedProductsTest(TestCase):
    def setUp(self):
        ...
        self.product1 = Product.objects.create(name='Test Product 1', price=9.99, category=self.category, brand_name='Test Brand X')
        self.product2 = Product.objects.create(name='Test Product 2', price=9.99, category=self.category, brand_name='Test Brand Y')
        self.product3 = Product.objects.create(name='Test Product 3', price=9.99, category=self.category, brand_name='Test Brand Z')
        self.product4 = Product.objects.create(name='Test Product 4', price=9.99, brand_name='Other Test Brand')
