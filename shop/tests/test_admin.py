...
class CategoryAdminTest(TestCase):
    ...
    def test_display_short_description_with_short_description(self):
        ...
        self.assertEqual(self.category_model_admin.short_description(test_category), short_description)
    ...
    def test_display_short_description_with_long_description(self):
        ...
        self.assertEqual(self.category_model_admin.short_description(test_category), f"{long_description[:150]}...")
